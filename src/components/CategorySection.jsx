...
const ACCENTS = {
  purple: {
    ...
    tag: 'border-violet-400/30 text-violet-600 dark:text-violet-300',
  },
  blue: {
    badge: 'from-brand-blue to-brand-cyan',
    glow: 'bg-brand-blue/25',
    text: 'text-brand-blue dark:text-brand-cyan',
    ring: 'group-hover:border-brand-cyan/60',
    ringOuter: 'border-brand-cyan/30',
    dot: 'bg-brand-cyan',
    chip: 'from-brand-blue to-blue-400',
    tag: 'border-brand-cyan/30 text-brand-blue dark:text-brand-cyan',
  },
  emerald: {
    ...
    tag: 'border-emerald-400/30 text-emerald-600 dark:text-emerald-300',
  },
}
