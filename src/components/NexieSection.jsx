      ...
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <div
          className="relative overflow-hidden rounded-3xl border border-[var(--border-subtle)]
            bg-gradient-to-br from-[var(--bg-surface)] to-[var(--bg-surface-2)] px-6 py-12 sm:px-12 sm:py-16"
        >
          <div className="pointer-events-none absolute -top-16 right-10 h-56 w-56 rounded-full bg-brand-cyan/20 blur-[90px]" />
          ...
          <div className="relative flex flex-col items-center gap-10 lg:flex-row lg:gap-16">
            <div className="w-full text-center lg:w-1/2 lg:text-left">
              ...
              <p className="mx-auto mt-4 max-w-lg text-base leading-relaxed text-[var(--text-secondary)] sm:text-lg lg:mx-0">
              ...
              <button
                type="button"
                onClick={onOpenChat}
                className="mt-7 inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-brand-blue via-brand-cyan to-brand-purple
            ...
            <div className="flex w-full justify-center lg:w-1/2">
              <div className="relative flex h-48 w-48 items-center justify-center sm:h-56 sm:w-56">
                <div className="absolute inset-0 rounded-full bg-gradient-to-br from-brand-blue/20 via-brand-cyan/15 to-brand-purple/20 blur-2xl" />
                <div
                  className="relative flex h-full w-full animate-[float_6s_ease-in-out_infinite] items-center justify-center
                    rounded-full border border-[var(--border-subtle)] bg-[var(--bg-surface-2)] shadow-2xl"
                >
